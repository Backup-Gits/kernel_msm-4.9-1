...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_NEEDFORSPEED)
extern struct cpufreq_governor cpufreq_gov_NeedForSpeed;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_NeedForSpeed)
#endif
